...
<div class="col-lg-6">
    <div class="center-container">
        <div class="main_container">
            <p class="main_text">Zmiana hasła do konta</p>
            <form:form method="post" modelAttribute="passwordChanger">
                <div>Stare hasło: <span id="oldPassword_validator"></span>
                    <form:password path="oldPassword" class="form-control" id="oldPassword"/></div>
                <br/>
                ...
                <div>Powtórz nowe hasło: <span id="repeatedNewPassword_validator"></span>
                    <form:password path="repeatedNewPassword" class="form-control" id="repeatedNewPassword"/></div>
                <br/>
...
<script type="module" src="${pageContext.request.contextPath}/resources/js/setNewPassword.js"
